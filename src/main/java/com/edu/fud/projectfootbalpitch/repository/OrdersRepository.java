...
public interface OrdersRepository extends JpaRepository<OrderEntity,Long> {
    ...
    //duc
    @Query(value = "SELECT * FROM project_football_pitch.orders where id = :orderId ",nativeQuery = true)
    OrderEntity findAllByOrder(long orderId);
    //huy
    @Query(value ="select  * from project_football_pitch.orders where user_id = :userID order by id desc",nativeQuery = true)
