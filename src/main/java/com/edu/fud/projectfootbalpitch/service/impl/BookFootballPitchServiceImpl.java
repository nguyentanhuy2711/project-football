...
public class BookFootballPitchServiceImpl implements BookFootballPitchService{
    ...
    public List<BookFootballPitchDto> findAllByUserID(long userID){
        ...
        for(BookFootballPitchEntity entity:bookFootballPitchEntityList){
            BookFootballPitchDto bookFootballPitchDto = beanConfig.modelMapper().map(entity,BookFootballPitchDto.class);
            bookFootballPitchDto.setTotalBooking(bookFootballPitchRepository.findPricePitch(userID,entity.getId())+
                    bookFootballPitchRepository.findPriceService(userID,entity.getId()));
            bookFootballPitchDto.setTotalPitch(bookFootballPitchRepository.findPricePitch(userID,entity.getId()));
            bookFootballPitchDto.setTotalService(bookFootballPitchRepository.findPriceService(userID,entity.getId()));
